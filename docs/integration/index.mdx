...
[Deployment Guide](/deployment), Section 2.2.
</Info>
...
The resulting `atl_sdm` binary can then be deployed and launched as described in [Deployment Guide](/deployment), Section 2.2.
...
[Deployment Guide](/deployment), Section 2.3.
</Info>
...
The resulting `proximity_sdm` binary can then be deployed and launched as described in [Deployment Guide](/deployment), Section 2.3.
