...
See [Sensor Input Processing Pipeline (SIPP)](/integration/components/sensor-input-pipeline).

### 3.2 Safety AI Monitor (SAIM)

See [Safety AI Monitor (SAIM)](/integration/components/ai-monitor).

### 3.3 Perception Container Monitor (PCM)

See [Perception Container Monitor (PCM)](/integration/components/perception-monitor).

### 3.4 Safety Event Integrator (SEI)

See [Safety Event Integrator (SEI)](/integration/components/event-integrator).

### 3.5 Safety Decision Maker (SDM)

See [Safety Decision Maker (SDM)](/integration/components/decision-maker).

### 3.6 Safety Black Box (SBB)

See [Safety Black Box (SBB)](/integration/components/black-box).

### 3.7 Safety User Interface (SUI)

See [Safety User Interface (SUI)](/integration/components/user-interface).
