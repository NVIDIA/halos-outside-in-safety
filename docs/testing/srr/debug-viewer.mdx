...
Use it when a graded score alone can't explain a failure — see [Interpreting the Report](/testing/srr/interpret-results) for the numbers, this page for the visual drill-down.
...
- [Interpreting the Report](/testing/srr/interpret-results) — the metrics behind the panels.
- [Test Scenarios](/testing/srr/scenarios) — the test cases you can run.
- [Quick Start Guide](/testing/srr/quickstart) — produce a run to view.
