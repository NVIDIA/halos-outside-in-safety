...
1. [Prerequisites](/getting-started/prerequisites) - Verify hardware and software requirements
2. [SIL — 2D Perception](/testing/sil/sil-2d) - Deploy testing harness in 30 minutes
3. [SIL Architecture](/testing/sil/architecture) - Deep dive into system design
4. [Isaac Sim Configuration](/testing/sil/components/isaac-sim) - Customize Isaac Sim scenes
5. [Overview](/testing/srr/overview) - Score the safety decision against ground truth with the **Regression Testing Reporter**
