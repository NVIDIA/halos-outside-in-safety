...
Drives the forklift Action Graph builders. One block per robot — adding a robot means adding a block here, with no code change. See [Isaac Sim Action Graphs](/testing/sil/components/action-graph) for what each builder produces.
...
- [Isaac Sim Action Graphs](/testing/sil/components/action-graph) - Action Graph details
- [Forklift Controller](/testing/sil/components/forklift-controller) - The service that drives the forklift along a route
- [SIL Architecture](/testing/sil/architecture) - System architecture
- [SIL — 2D Perception](/testing/sil/sil-2d) - Deployment guide
